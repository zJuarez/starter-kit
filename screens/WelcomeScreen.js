...
GoogleSignin.configure({
    webClientId: "804315558824-82fsnnqs3gevbdq8naitec859qdeqjs5.apps.googleusercontent.com",
    offlineAccess : true,
})
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: themeColors.bg }]}>
            <View style={[styles.containerX]}>
                ...
                <View >
                    ...
                    <TouchableOpacity onPress={() => signInGoogle()} style={[styles.button, { backgroundColor: themeColors.crema }]}>
                        <View style={{
                            marginHorizontal: 12,
                            flexDirection: "row",
